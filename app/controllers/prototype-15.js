...
var controller = {
    ...
    appointee: function(req, res) {
        if (req.body.radioGroup === 'appointee') {
            res.render('prototype-beta-15/submit-your-appeal/004-appointee-details');
        } else if (req.body.radioGroup === 'nonAppointee') {
            res.render('prototype-beta-15/submit-your-appeal/003-mrn-date');
        }
    },
    ...
    supporter: function(req, res) {
        if (req.body.radioGroup === 'yes') {
            res.render('prototype-beta-15/submit-your-appeal/010-supporter-details');
    ...
    hearing: function(req, res) {
        if (req.body.radioGroup === 'attend') {
            res.render('prototype-beta-15/submit-your-appeal/014-hearing-arrangements-needed');
        } else if (req.body.radioGroup === 'notAttend') {
            res.render('prototype-beta-15/submit-your-appeal/013-hearing-not-attending');
        }
    },

    arrangements: function(req, res) {
        if (req.body.radioGroup === 'arrangementsRequired') {
            res.render('prototype-beta-15/submit-your-appeal/015-hearing-arrangements');
        } else if (req.body.radioGroup === 'arrangementsNotRequired') {
            res.render('prototype-beta-15/submit-your-appeal/016-hearing-dates');
        }
    },
...
// To create a moment object from user input (e.g. MRN date) you would do the following:
        ...
        if (DateUtils.isLessThanOrEqualToAMonth(mDate)) {
            res.render('prototype-beta-15/submit-your-appeal/004-your-details');
            return;
        }

        if (DateUtils.isGreaterThanAMonth(mDate) && DateUtils.isLessThanOrEqualToThirteenMonths(mDate)) {
            res.render('prototype-beta-15/submit-your-appeal/003-3-why-appeal-late-1month');
            return;
        }

        if (DateUtils.isGreaterThanThirteenMonths(mDate)) {
            res.render('prototype-beta-15/submit-your-appeal/003-4-why-appeal-late-13months');
            return;
        }
    },

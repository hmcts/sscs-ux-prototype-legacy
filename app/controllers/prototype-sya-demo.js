...
var controller = {
    ...
    appointee: function(req, res) {
        if (req.body.radioGroup === 'appointee') {
            res.render('prototype-sya-demo/submit-your-appeal/004-your-name-appointee');
        } else if (req.body.radioGroup === 'nonAppointee') {
            res.render('prototype-sya-demo/submit-your-appeal/004-your-name');
        }
    },

    representative: function(req, res) {
        if (req.body.radioGroup === 'rep') {
            res.render('prototype-sya-demo/submit-your-appeal/009-reps-details');
        } else if (req.body.radioGroup === 'noRep') {
            res.render('prototype-sya-demo/submit-your-appeal/011-why-are-you-appealing');
        }
    },

  representativeApp: function(req, res) {
        if (req.body.radioGroup === 'repApp') {
            res.render('prototype-sya-demo/submit-your-appeal/009-reps-details-appointee');
        } else if (req.body.radioGroup === 'noRepApp') {
            res.render('prototype-sya-demo/submit-your-appeal/011-why-are-you-appealing-appointee');
        }
    },
    ...
    hearing: function(req, res) {
        if (req.body.radioGroup === 'attend') {
            res.render('prototype-sya-demo/submit-your-appeal/014-hearing-arrangements-needed');
        } else if (req.body.radioGroup === 'notAttend') {
            res.render('prototype-sya-demo/submit-your-appeal/013-hearing-not-attending');
        }
    },

    hearingApp: function(req, res) {
        if (req.body.radioGroup === 'attendApp') {
            res.render('prototype-sya-demo/submit-your-appeal/014-hearing-arrangements-needed-appointee');
        } else if (req.body.radioGroup === 'notAttendApp') {
            res.render('prototype-sya-demo/submit-your-appeal/013-hearing-not-attending-appointee');
        }
    },

    arrangements: function(req, res) {
        if (req.body.radioGroup === 'arrangementsRequired') {
            res.render('prototype-sya-demo/submit-your-appeal/015-hearing-arrangements');
        } else if (req.body.radioGroup === 'arrangementsNotRequired') {
            res.render('prototype-sya-demo/submit-your-appeal/016-hearing-availability');
        }
    },

    arrangementsApp: function(req, res) {
        if (req.body.radioGroup === 'arrangementsRequiredApp') {
            res.render('prototype-sya-demo/submit-your-appeal/015-hearing-arrangements-appointee');
        } else if (req.body.radioGroup === 'arrangementsNotRequiredApp') {
            res.render('prototype-sya-demo/submit-your-appeal/016-hearing-availability-appointee');
        }
    },
    ...
    mobile: function(req, res) {
        if (req.body.radioGroup === 'usemobile') {
            res.render('prototype-sya-demo/submit-your-appeal/007-sms-confirmation');
        } else if (req.body.radioGroup === 'newmobile') {
            res.render('prototype-sya-demo/submit-your-appeal/006-enter-mobile-number');
        }
    },

    mobileApp: function(req, res) {
        if (req.body.radioGroup === 'usemobileApp') {
            res.render('prototype-sya-demo/submit-your-appeal/007-sms-confirmation-appointee');
        } else if (req.body.radioGroup === 'newmobileApp') {
            res.render('prototype-sya-demo/submit-your-appeal/006-enter-mobile-number-appointee');
        }
    },

    mobileboth: function(req, res) {
        if (req.body.radioGroup === 'usemobileboth') {
            res.render('prototype-sya-demo/submit-your-appeal/007-sms-email-confirmation');
        } else if (req.body.radioGroup === 'newmobileboth') {
            res.render('prototype-sya-demo/submit-your-appeal/006-enter-mobile-number-both');
        }
    },
   ...
   checkdate: function(req, res) {
        if (req.body.radioGroup === 'correctdate') {
            res.render('prototype-sya-demo/submit-your-appeal/003-3-why-appeal-late-1month');
        } else if (req.body.radioGroup === 'wrongdate') {
            res.render('prototype-sya-demo/submit-your-appeal/003-mrn-date');
        }
    },
    ...
    notifications: function(req, res) {
        if (req.body.radioGroup === 'email') {
            res.render('prototype-sya-demo/submit-your-appeal/006-enter-email');
        } else if (req.body.radioGroup === 'text') {
            res.render('prototype-sya-demo/submit-your-appeal/006-mobile-number-provided');

        } else if (req.body.radioGroup === 'both') {
            res.render('prototype-sya-demo/submit-your-appeal/006-enter-email-both');

        } else if (req.body.radioGroup === 'neither') {
            res.render('prototype-sya-demo/submit-your-appeal/008-representative');
        }
    },
        ...
        if (req.body.radioGroup === 'diffAddress') {
            res.render('prototype-sya-demo/submit-your-appeal/004-their-address-appointee');
        } else if (req.body.radioGroup === 'sameAddress') {
            res.render('prototype-sya-demo/submit-your-appeal/005-sms-sign-up-address-same-appointee');
        }
    },
 ...
 mrnhave: function(req, res) {
        if (req.body.radioGroup === 'yesMRN') {
            res.render('prototype-sya-demo/submit-your-appeal/002-dwp-office');
        } else if (req.body.radioGroup === 'noMRN') {
            res.render('prototype-sya-demo/submit-your-appeal/002-contacted-dwp');
        }
    },

 contactdwp: function(req, res) {
        if (req.body.radioGroup === 'yesContactDWP') {
            res.render('prototype-sya-demo/submit-your-appeal/003-1-no-mrn');
        } else if (req.body.radioGroup === 'noContactDWP') {
            res.render('prototype-sya-demo/submit-your-appeal/003-2-contact-dwp');
        }
    },
...
// To create a moment object from user input (e.g. MRN date) you would do the following:
        ...
        if (DateUtils.isLessThanOrEqualToAMonth(mDate)) {
            res.render('prototype-sya-demo/submit-your-appeal/004-appointee');
            return;
        }

        if (DateUtils.isGreaterThanAMonth(mDate) && DateUtils.isLessThanOrEqualToThirteenMonths(mDate)) {
            res.render('prototype-sya-demo/submit-your-appeal/003-0-check-mrn-date');
            return;
        }

        if (DateUtils.isGreaterThanThirteenMonths(mDate)) {
            res.render('prototype-sya-demo/submit-your-appeal/003-4-why-appeal-late-13months');
            return;
        }
    },
...
validateCaseReference: function (req, res) {
    ...
    if(surname === 'wrong') {
        ...
        res.render('prototype-sya-demo/track-your-appeal-error-no-match', {
    ...
    if(errors.reference.length || errors.surname.length) {
        res.render('prototype-sya-demo/track-your-appeal-error', {
            errorMessages: errors,
            caseRefNumber: reference,
            surname: surname
        });
    ...
    .then(function (result, error) {
        ...
        res.render('prototype-sya-demo/status-pb-one', data);
                //res.render('prototype-sya-demo/status-pb-four', data);
                //res.render('prototype-sya-demo/status-pb-seven', data);
                //res.render('prototype-sya-demo/status-pb-ten', data);
            }, function (error) {
                res.send('HTTP '  + error.status + ': ' + error.message);
            });
...
validateCaseReferenceMulti: function(req, res) {
    ...
    if(caseRef1 === '' && caseRef2 === '' && caseRef3 === '') {
        ...
        res.render('prototype-sya-demo/track-your-appeal-error-multi', {
            errorMessages: errors,
    ...
    .then(function (result, error) {
        var data = result.body;
        data.status = data.status.toLowerCase().split('_').join('');
        res.render('prototype-sya-demo/status', data);
    }, function (error) {
        res.send('HTTP '  + error.status + ': ' + error.message);
    });
},
...
validateReference: function(req, res) {
    ...
    if(errors.length) {
        res.render('prototype-sya-demo/validate-reference-error', {
            errors: errors,
            reference: reference
        });
        return;
    ...
    res.render('prototype-sya-demo/validate-surname');
},
...
validateSurname: function(req, res) {
    ...
    if(errors.length) {
        res.render('prototype-sya-demo/validate-surname-error', {
            errors: errors,
            reference: reference,
            surname: surname
        });

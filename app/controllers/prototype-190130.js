...
var controller = {
    ...
    appointee: function(req, res) {
        if (req.body.radioGroup === 'appointee') {
            res.render('prototype-beta-190130/submit-your-appeal/004-your-name-appointee');
        } else if (req.body.radioGroup === 'nonAppointee') {
            res.render('prototype-beta-190130/submit-your-appeal/004-your-name');
        }
    },

    representative: function(req, res) {
        if (req.body.radioGroup === 'rep') {
            res.render('prototype-beta-190130/submit-your-appeal/009-reps-details');
        } else if (req.body.radioGroup === 'noRep') {
            res.render('prototype-beta-190130/submit-your-appeal/011-why-are-you-appealing');
        }
    },
    ...
    hearing: function(req, res) {
        if (req.body.radioGroup === 'attend') {
            res.render('prototype-beta-190130/submit-your-appeal/014-hearing-arrangements-needed');
        } else if (req.body.radioGroup === 'notAttend') {
            res.render('prototype-beta-190130/submit-your-appeal/013-hearing-not-attending');
        }
    },

    hearingApp: function(req, res) {
        if (req.body.radioGroup === 'attendApp') {
            res.render('prototype-beta-190130/submit-your-appeal/014-hearing-arrangements-needed-appointee');
        } else if (req.body.radioGroup === 'notAttendApp') {
            res.render('prototype-beta-190130/submit-your-appeal/013-hearing-not-attending-appointee');
        }
    },

    arrangements: function(req, res) {
        if (req.body.radioGroup === 'arrangementsRequired') {
            res.redirect('/prototype-beta-190130/submit-your-appeal/015-hearing-arrangements');
        } else if (req.body.radioGroup === 'arrangementsNotRequired') {
            res.render('prototype-beta-190130/submit-your-appeal/016-hearing-availability');
        }
    },

    arrangementsApp: function(req, res) {
        if (req.body.radioGroup === 'arrangementsRequiredApp') {
            res.render('prototype-beta-190130/submit-your-appeal/015-hearing-arrangements-appointee');
        } else if (req.body.radioGroup === 'arrangementsNotRequiredApp') {
            res.render('prototype-beta-190130/submit-your-appeal/016-hearing-availability-appointee');
        }
    },
    ...
    availabilityApp: function(req, res) {
        if (req.body.radioGroup === 'datesYesApp') {
            res.render('prototype-beta-190130/submit-your-appeal/016-hearing-dates-appointee');
        } else if (req.body.radioGroup === 'datesNoApp') {
            res.render('prototype-beta-190130/submit-your-appeal/017-check-your-answers-appointee');
        }
    },
    ...
    mobile: function(req, res) {
        if (req.body.radioGroup === 'usemobile') {
            res.render('prototype-beta-190130/submit-your-appeal/007-sms-confirmation');
        } else if (req.body.radioGroup === 'newmobile') {
            res.render('prototype-beta-190130/submit-your-appeal/006-enter-mobile-number');
        }
    },

    mobileApp: function(req, res) {
        if (req.body.radioGroup === 'usemobileApp') {
            res.render('prototype-beta-190130/submit-your-appeal/007-sms-confirmation-appointee');
        } else if (req.body.radioGroup === 'newmobileApp') {
            res.render('prototype-beta-190130/submit-your-appeal/006-enter-mobile-number-appointee');
        }
    },

    mobileboth: function(req, res) {
        if (req.body.radioGroup === 'usemobileboth') {
            res.render('prototype-beta-190130/submit-your-appeal/007-sms-email-confirmation');
        } else if (req.body.radioGroup === 'newmobileboth') {
            res.render('prototype-beta-190130/submit-your-appeal/006-enter-mobile-number-both');
        }
    },
    ...
    checkdate: function(req, res) {
        if (req.body.radioGroup === 'correctdate') {
            res.render('prototype-beta-190130/submit-your-appeal/003-3-why-appeal-late-1month');
        } else if (req.body.radioGroup === 'wrongdate') {
            res.render('prototype-beta-190130/submit-your-appeal/003-mrn-date');
        }
    },
    ...
    notifications: function(req, res) {
        if (req.body.radioGroup === 'yesNotifications') {
            res.render('prototype-beta-190130/submit-your-appeal/016-notifications-how-receive');
    ...
    notificationstype: function(req, res) {
        if (req.body.radioGroup === 'email') {
            res.render('prototype-beta-190130/submit-your-appeal/016-notifications-email');

        } else if (req.body.radioGroup === 'text') {
            res.render('prototype-beta-190130/submit-your-appeal/016-notifications-text');

        } else if (req.body.radioGroup === 'both') {
            res.render('prototype-beta-190130/submit-your-appeal/016-notifications-email-both');
        }
    },
    ...
    addressApp: function(req, res) {
        if (req.body.radioGroup === 'diffAddress') {
            res.render('prototype-beta-190130/submit-your-appeal/004-their-address-appointee');
        } else if (req.body.radioGroup === 'sameAddress') {
            res.render('prototype-beta-190130/submit-your-appeal/005-sms-sign-up-appointee');
        }
    },
    ...
    mrnhave: function(req, res) {
        if (req.body.radioGroup === 'yesMRN') {
            ...
            res.render('prototype-beta-190130/submit-your-appeal/002-contacted-dwp');
        }
    },

    contactdwp: function(req, res) {
        if (req.body.radioGroup === 'yesContactDWP') {
            res.render('prototype-beta-190130/submit-your-appeal/003-1-no-mrn');
        } else if (req.body.radioGroup === 'noContactDWP') {
            res.render('prototype-beta-190130/submit-your-appeal/003-2-contact-dwp');
        }
    },
        ...
        if (req.body.radioGroup === 'online') {
            res.render('prototype-beta-190130/idam-set-up');
        } else if (req.body.radioGroup === 'post') {
            res.render('prototype-beta-190130/evidence-post');
        }
    },
        ...
        if (req.body.radioGroup === 'statement') {
            res.render('prototype-beta-190130/evidence-statement');
        } else if (req.body.radioGroup === 'upload') {
            res.render('prototype-beta-190130/evidence-upload');
        }
    },

        evidenceprovide: function(req, res) {
        if (req.body.radioGroup === 'yesupload') {
            res.render('prototype-beta-190130/submit-your-appeal/012-evidence-upload');
        } else if (req.body.radioGroup === 'noupload') {
            res.render('prototype-beta-190130/submit-your-appeal/013-your-hearing');
        }
    },
        ...
        if (req.body.radioGroup === 'savesignin') {
            res.render('prototype-beta-190130/submit-your-appeal/idam-sign-in-activated');
        } else if (req.body.radioGroup === 'savecreate') {
            res.render('prototype-beta-190130/submit-your-appeal/idam-create-account');
        }
    },

        uploadaccount: function(req, res) {
        if (req.body.radioGroup === 'uploadsignin') {
            res.render('prototype-beta-190130/idam-sign-in-upload');
        } else if (req.body.radioGroup === 'uploadcreate') {
            res.render('prototype-beta-190130/idam-create-account-upload');
        }
    },
        ...
        if (req.body.radioGroup === 'appealsignin') {
            res.render('prototype-beta-190130/idam-sign-in-access');
        } else if (req.body.radioGroup === 'appealcreate') {
            res.render('prototype-beta-190130/idam-create-account-access');
        }
    },
        ...
        if (req.body.radioGroup === 'useemail') {
            res.render('prototype-beta-190130/submit-your-appeal/saved-appeal-email-sent');
        } else if (req.body.radioGroup === 'newemail') {
            res.render('prototype-beta-190130/submit-your-appeal/saved-about-to-update-email');
        }
    },
        ...
        if (req.body.radioGroup === 'yesupdateemail') {
            res.render('prototype-beta-190130/submit-your-appeal/saved-appeal-email-new');
        } else if (req.body.radioGroup === 'noupdateemail') {
            res.render('prototype-beta-190130/submit-your-appeal/saved-appeal-confirm-email');
        }
    },
        ...
        if (req.body.radioGroup === 'smsyes') {
            res.render('prototype-beta-190130/submit-your-appeal/006-sms-mobile-number-provided');
        } else if (req.body.radioGroup === 'smsno') {
            res.render('prototype-beta-190130/submit-your-appeal/008-representative');
        }
    },

                smssignupapp: function(req, res) {
        if (req.body.radioGroup === 'smsyes') {
            res.render('prototype-beta-190130/submit-your-appeal/006-sms-mobile-number-provided-appointee');
        } else if (req.body.radioGroup === 'smsno') {
            res.render('prototype-beta-190130/submit-your-appeal/008-representative-appointee');
        }
    },
        ...
        if (req.body.radioGroup === 'changeEmail') {
            res.render('prototype-beta-190130/manage/your-new-email-address');
        } else if (req.body.radioGroup === 'stopEmail') {
            res.render('prototype-beta-190130/manage/stop-receiving-email-updates');
        }
    },
  ...
  hearingDates: function(req, res) {
    ...
    res.render('prototype-beta-190130/submit-your-appeal/016-hearing-dates', { datesCantAttend });
  },
  ...
  hearingArrangements: function(req, res) {
    res.render('prototype-beta-190130/submit-your-appeal/015-hearing-arrangements', { languageInterpreter, signLanguage })
  },


  reasonForAppeal: function(req, res) {
      const reasonsForAppeal = req.session.reasonsForAppeal || null;
      res.render('prototype-beta-190130/submit-your-appeal/011-why-are-you-appealing', { reasonsForAppeal });
  },
  ...
  editReasonForAppeal: function(req, res) {
      ...
      res.render('prototype-beta-190130/submit-your-appeal/011-why-are-you-appealing-fields', { reason, index });
  },
  ...
  updateEditedReasonForAppeal: function(req, res) {
    ...
    res.redirect('/prototype-beta-190130/submit-your-appeal/011-why-are-you-appealing')
  },
...
mrnDate: function(req, res) {
    ...
    if (DateUtils.isLessThanOrEqualToAMonth(mDate)) {
        res.render('prototype-beta-190130/submit-your-appeal/002-dwp-office');
        return;
    }

    if (DateUtils.isGreaterThanAMonth(mDate) && DateUtils.isLessThanOrEqualToThirteenMonths(mDate)) {
        res.render('prototype-beta-190130/submit-your-appeal/003-0-check-mrn-date');
        return;
    }

    if (DateUtils.isGreaterThanThirteenMonths(mDate)) {
        res.render('prototype-beta-190130/submit-your-appeal/003-4-why-appeal-late-13months');
        return;
    }
},
...
validateCaseReference: function (req, res) {
    ...
    if(surname === 'wrong') {
        ...
        res.render('prototype-190130/track-your-appeal-error-no-match', {
    ...
    if(errors.reference.length || errors.surname.length) {
        res.render('prototype-190130/track-your-appeal-error', {
            errorMessages: errors,
            caseRefNumber: reference,
            surname: surname
        });
    ...
    .then(function (result, error) {
        ...
        res.render('prototype-190130/status-pb-one', data);
                //res.render('prototype-190130/status-pb-four', data);
                //res.render('prototype-190130/status-pb-seven', data);
                //res.render('prototype-190130/status-pb-ten', data);
            }, function (error) {
                res.send('HTTP '  + error.status + ': ' + error.message);
            });
...
validateCaseReferenceMulti: function(req, res) {
    ...
    if(caseRef1 === '' && caseRef2 === '' && caseRef3 === '') {
        ...
        res.render('prototype-190130/track-your-appeal-error-multi', {
            errorMessages: errors,
    ...
    .then(function (result, error) {
        var data = result.body;
        data.status = data.status.toLowerCase().split('_').join('');
        res.render('prototype-190130/status', data);
    }, function (error) {
        res.send('HTTP '  + error.status + ': ' + error.message);
    });
},
...
validateReference: function(req, res) {
    ...
    if(errors.length) {
        res.render('prototype-190130/validate-reference-error', {
            errors: errors,
            reference: reference
        });
        return;
    ...
    res.render('prototype-190130/validate-surname');
},
...
validateSurname: function(req, res) {
    ...
    if(errors.length) {
        res.render('prototype-190130/validate-surname-error', {
            errors: errors,
            reference: reference,
            surname: surname
        });
    ...
    evidenceReminder: function(req, res, next) {
        res.render('prototype-beta-190130/submit-your-appeal/012-evidence-reminder');
    },
    ...
    idamAccountActivated: function(req, res, next) {
        ...
        res.render('prototype-beta-190130/idam-account-activated');
    },

    idamCreateAccount: function(req, res, next) {
        res.locals.serviceName = '';
        res.render('prototype-beta-190130/idam-create-account')
    },

    idamCreatePassword: function(req, res, next) {
        res.locals.serviceName = '';
        res.render('prototype-beta-190130/idam-create-password');
    },

    idamSignIn: function(req, res, next) {
        res.locals.serviceName = '';
        res.render('prototype-beta-190130/idam-sign-in');
    },

    idamSignInActivated: function(req, res, next) {
        res.locals.serviceName = '';
        res.render('prototype-beta-190130/idam-sign-in-activated');
    },

    idamSignInError: function(req, res, next) {
        res.locals.serviceName = '';
        res.render('prototype-beta-190130/idam-sign-in-error');
    },

    idamVerifyEmail: function(req, res, next) {
        res.locals.serviceName = '';
        res.render('prototype-beta-190130/idam-verify-email');
    },
};
